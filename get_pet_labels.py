...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           # for-loop to check if word in pet name is only alphabets - if true?
           # append word to pet_name separated by trailing-white-space  
           for word in word_list_pet_image:
                if word.isalpha():
                    pet_label += word + " "
           # Strip-off trailing-white-space characters
